        ...
        <div className="Signup">
            ...
            <div className='inforcontainer'>
                <div className='inputContainer'>
                    <input onClick={() => inputClick('accountName')} id='accountName' placeholder='tên tài khoản'/>
                    <input onClick={() => inputClick('firstName')} id='firstName' placeholder='Họ'/>
                </div>
                <div className='inputContainer'>
                    <input onClick={() => inputClick('password')} id='password' placeholder='Mật khẩu'/>
                    <input onClick={() => inputClick('lastName')} id='lastName' placeholder='tên'/>
                </div>
                <div className='inputContainer'>
                    <input onClick={() => inputClick('rePassword')} id='rePassword' placeholder='Nhập lại mật khẩu'/>
                    <input onClick={() => inputClick('email')} id='email' placeholder='Email'/>
                </div>
                <div className='inputContainer'>
                    <label htmlFor="birthday">Sinh nhật:</label>
                    <input onClick={() => inputClick('birthday')} type="date" id='birthday' name="birthday" />
                    <input onClick={() => inputClick('phone')} type="tel" id='phone' name="phone" pattern="[0-9]{3}-[0-9]{3}-[0-9]{4}" required placeholder='SĐT' />
                </div>
                <div className='inputContainer'>
                    <div>
